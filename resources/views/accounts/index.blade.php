                ...
                @if($paused)
                    <div class="alert alert-danger">
                        ...
                        You have reached the limit of your plan. <a
                                onClick="ga('send', 'event', 'button', 'click', 'upgrade_alert_integrations');"
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="greeting-button">
                                    <button class="btn upgrade-btn nr_connect_accounts_button"
                                            onClick="ga('send', 'event', 'button', 'click', 'add_integration_dash');"><i
                                                class="fa fa-plus-circle" aria-hidden="true"></i> Add Integration
                                        <span class="nr-loader fa fa-spin fa-spinner margin-left-5 hidden"></span>
                                    </button>
                                </div>
                                <h1 class="title">Integrations</h1>
                                <p class="">This is where you can integrate your favorite online applications with Ninja
                                    Reports. Click Add Integration to allow Ninja Reports to access your account
                                    data.</p>
                            </div>
                                                    ...
                                                    <td>
                                                        @if($account->type != 'stripe')
                                                            <a class="btn btn-xs btn-primary"
                                                               href="{{ route('accounts.setting', $account->type) }}">Settings</a>
                                                        @endif
