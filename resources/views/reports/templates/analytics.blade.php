                                                        ...
                                                        <tr>
                                                            <td role="modules-container" style="padding: 0px 0px 0px 0px; color: #000000; text-align: left;" bgcolor="#f2f2f2" width="100%" align="left">
                                                                ...
                                                                <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                    ...
                                                                    <tr>
                                                                        <td height="100%" valign="top">
                                                                            <table bgcolor="#1080f2" style="background:#1080f2;width:100%;max-height:75px;" height="75px;" width="100%" cellpadding="0" cellspacing="0">
                                                                                <tbody><tr><td style="width:75px;height:75px;"><img class="max-width" border="0" style="display:block;color:#000000;text-decoration:none;font-family:Helvetica, arial, sans-serif;font-size:16px;" width="75" height="75" src="https://marketing-image-production.s3.amazonaws.com/uploads/ffcadde0ac26a4cb4fe070253e4736136814feb5c998ea12427c3bccaad9bb0346312de31d0354fb73049f269b13b9735adf81539ce22a07049d9ee17721a95d.png" alt=""></td><td style="padding:0;margin:0"><h1 style="margin:0;padding:0;color:#fff;">NINJA REPORTS</h1></td>
                                                                                    </tr>
                                                                                </tbody></table>
                                                                        </td>
                                                                    </tr>
                                                                ...
                                                                <table  border="0"
                                                                    ...
                                                                    <tr role='module-content'>
                                                                        <td height="100%" valign="top">
                                                                            @if($devices_graph_url && $devices_graph_url !="")
                                                                            <table border="1px" style="border:1px solid #cccccc;margin-bottom:1%" cellpadding="0" cellspacing="0" width="100%">
                                                                                <tbody><tr><th style="background-color:#cccccc;padding:5px;">DEVICES</th></tr><tr>
                                                                                        <td width="100%" style="text-align:center;padding:10px;" background-color="#ffffff">
                                                                                            {!! $devices_graph_url == 'no_data' ? 'No data': '<img style="max-width: 100%" src="'.$devices_graph_url.'"/>' !!}
                                                                                        </td></tr>
                                                                                </tbody></table>
                                                                            @endif

                                                                            @if($locations_graph_url && $locations_graph_url !="")
                                                                            <table border="1px" style="border:1px solid #cccccc;margin-bottom:1%" cellpadding="0" cellspacing="0" width="100%">
                                                                                <tbody><tr><th style="background-color:#cccccc;padding:5px;">LOCATIONS</th></tr><tr>
                                                                                        <td width="100%" style="text-align:center;padding:10px;" background-color="#ffffff">
                                                                                            {!! $locations_graph_url == 'no_data' ? 'No data': '<img style="max-width: 100%" src="'.$locations_graph_url.'"/>' !!}
                                                                                        </td></tr>
                                                                                </tbody></table>
                                                                            @endif
                                                                            
                                                                            @if($pageview_graph_url && $pageview_graph_url !="")
                                                                            <table border="1px" style="border:1px solid #cccccc;margin-bottom:1%" cellpadding="0" cellspacing="0" width="100%">
                                                                                <tbody><tr><th style="background-color:#cccccc;padding:5px;">Pageview By Day</th></tr><tr>
                                                                                        <td width="100%" style="text-align:center;padding:10px;" background-color="#ffffff">
                                                                                            {!! $pageview_graph_url == 'no_data' ? 'No data': '<img style="max-width: 100%" src="'.$pageview_graph_url.'"/>' !!}
                                                                                        </td></tr>
                                                                                </tbody></table>
                                                                            @endif
                                                                            
                                                                            @if($channel_graph_url && $channel_graph_url !="")
                                                                            <table border="1px" style="border:1px solid #cccccc;margin-bottom:1%" cellpadding="0" cellspacing="0" width="100%">
                                                                                <tbody><tr><th style="background-color:#cccccc;padding:5px;">Channels</th></tr><tr>
                                                                                        <td width="100%" style="text-align:center;padding:10px;" background-color="#ffffff">
                                                                                            {!! $channel_graph_url == 'no_data' ? 'No data': '<img style="max-width: 100%" src="'.$channel_graph_url.'"/>' !!}
                                                                                        </td></tr>
                                                                                </tbody></table>
                                                                            @endif
                                                                ...
                                                                @if($top_5_sources && $top_5_sources!="")
                                                                ...
                                                                @if($top_5_campaigns && $top_5_campaigns!="")
                                                                <table class="module" role="module" data-type="code" border="0" cellpadding="10" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                    <tr>
                                                                        <td height="100%" valign="top" style="text-align:center;padding:10px;margin:10px 0">
                                                                            <h2 style="text-align:center;font-size:18px;margin:10px0 0 10px 0;padding:10px 0 10px 0">Top 5 Visitors by Campaigns</h2>
                                                                            {!! $top_5_campaigns !!}
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                ...
                                                                @if($top_5_pageview && $top_5_pageview!="")
                                                                <table class="module" role="module" data-type="code" border="0" cellpadding="10" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                    <tr>
                                                                        <td height="100%" valign="top" style="text-align:center;padding:10px;margin:10px 0">
                                                                            <h2 style="text-align:center;font-size:18px;margin:10px0 0 10px 0;padding:10px 0 10px 0">Top 5 Visitors by Page</h2>
                                                                            {!! $top_5_pageview !!}
                                                                        </td>
                                                                    </tr>
                                                                </table>
