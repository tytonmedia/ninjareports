                                                        ...
                                                        <tr>
                                                            <td role="modules-container" style="padding: 0px 0px 0px 0px; color: #000000; text-align: left;" bgcolor="#f2f2f2" width="100%" align="left">
                                                                ...
                                                                <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                    <tr>
                                                                        <td height="100%" valign="top">
                                                                            <div class="header" sttyle="background:#1080f2;"></div>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        <td height="100%" valign="top">
                                                                            <div style="text-align:center;margin:10px 0 30px 0">
                                                                                <h2 style="padding:5px 0;margin:0">Your Daily Google Analytics Report</h2>
                                                                                <p style="padding:5px 0;margin:0">www.ninjareports.com</p>
                                                                                <p style="color:#999;padding:5px 0;margin:0">Friday, January 6th 2017</p>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td height="100%" valign="top">
                                                                                                    <div class="box" style="text-align:center;border:1px solid #ccc;background:#fff;background-color:#fff;padding:15px;">
                                                                                                        <h2 style="padding:0;margin:0">234</h2>
                                                                                    ...
                                                                                    <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                                        <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                            <tr>
                                                                                                <td height="100%" valign="top">
                                                                                                    <div class="box" style="text-align:center;border:1px solid #ccc;background:#fff;background-color:#fff;padding:15px;">
                                                                                                        <h2 style="padding:0;margin:0">2:35</h2>
                                                                                    ...
                                                                                    <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                                        <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                            <tr>
                                                                                                <td height="100%" valign="top">
                                                                                                    <div class="box" style="text-align:center;border:1px solid #ccc;background:#fff;background-color:#fff;padding:15px;">
                                                                                                        <h2 style="padding:0;margin:0">30%</h2>
                                                                                    ...
                                                                                    <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                                        <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                            <tr>
                                                                                                <td height="100%" valign="top">
                                                                                                    <div class="box" style="text-align:center;border:1px solid #ccc;background:#fff;background-color:#fff;padding:15px;">
                                                                                                        <h2 style="padding:0;margin:0">623</h2>
                                                                                    ...
                                                                                    <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                                        <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                            <tr>
                                                                                                <td height="100%" valign="top">
                                                                                                    <div class="box" style="text-align:center;border:1px solid #ccc;background:#fff;background-color:#fff;padding:15px;">
                                                                                                        <h2 style="padding:0;margin:0">2.56</h2>
                                                                                    ...
                                                                                    <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                                        <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                            <tr>
                                                                                                <td height="100%" valign="top">
                                                                                                    <div class="box" style="text-align:center;border:1px solid #ccc;background:#fff;background-color:#fff;padding:15px;">
                                                                                                        <h2 style="padding:0;margin:0">67%</h2>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td height="100%" valign="top">
                                                                                                    <table width="100%" border="1px" style="1px solid #cccccc" cellpadding="0" cellspacing="0">
                                                                                                        <tbody><tr><th style="background-color:#cccccc;padding:5px;">DEVICES</th></tr><tr><td width="100%" style="background-color:#ffffff;padding:10px;" background-color="#ffffff">Graph</td></tr>
                                                                                                        </tbody></table>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    ...
                                                                                    <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                                        <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                            <tr>
                                                                                                <td height="100%" valign="top">
                                                                                                    <table width="100%" border="1px" style="1px solid #cccccc" cellpadding="0" cellspacing="0">
                                                                                                        <tbody><tr><th style="background-color:#cccccc;padding:5px;">LOCATIONS</th></tr><tr><td width="100%" style="background-color:#ffffff;padding:10px;" background-color="#ffffff">Graph</td></tr>
                                                                                                        </tbody></table>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                ...
                                                                <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                    <tr>
                                                                        <td height="100%" valign="top">
                                                                            <h2 style="text-align:center;font-size:18px;margin:0 0 10px 0;padding:0 0 10px 0">Top 10 Visitors by Source</h2>
                                                                            <table width="100%" cellpadding="5" cellspacing="0" style="background:#fff">
                                                                                <tbody><tr>
                                                                                    ...
                                                                                    <tr style="border-bottom:1px solid #ccc">
                                                                                        ...
                                                                                        <td style="padding:5px;">2.52</td>
                                                                                        <td style="padding:5px;">2:52</td>
                                                                                    </tr>

                                                                                    <tr style="border-bottom:1px solid #ccc"><td>linkedin.com</td>
                                                                                        <td style="padding:5px;">11</td>
                                                                                        <td style="padding:5px;">27%</td>
                                                                                        <td style="padding:5px;">72%</td>
                                                                                        <td style="padding:5px;">1.52</td>
                                                                                        <td style="padding:5px;">1:52</td>
                                                                                    </tr>


                                                                                    <tr style="border-bottom:1px solid #ccc"><td>google</td>
                                                                                        <td style="padding:5px;">7</td>
                                                                                        <td style="padding:5px;">79%</td>
                                                                                        <td style="padding:5px;">22%</td>
                                                                                        <td style="padding:5px;">4.52</td>
                                                                                        <td style="padding:5px;">5:52</td>
                                                                                    </tr>


                                                                                    <tr style="border-bottom:1px solid #ccc"><td>quora.com</td>
