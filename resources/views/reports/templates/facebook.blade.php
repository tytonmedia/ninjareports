                                                        ...
                                                        <tr>
                                                            <td role="modules-container" style="padding: 0px 0px 0px 0px; color: #000000; text-align: left;" bgcolor="#f2f2f2" width="100%" align="left">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td height="100%" valign="top">
                                                                                                    <div class="box" style="text-align:center;border:1px solid #ccc;background:#fff;background-color:#fff;padding:15px;">
                                                                                                        <h2 style="padding:0;margin:0">{{ $total_clicks }}</h2>
                                                                                                        <label style="padding:0;margin:0">Clicks</label>
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    ...
                                                                                    <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                                        <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                            <tr>
                                                                                                <td height="100%" valign="top">
                                                                                                    <div class="box" style="text-align:center;border:1px solid #ccc;background:#fff;background-color:#fff;padding:15px;">
                                                                                                        <h2 style="padding:0;margin:0">{{ $total_impressions }}</h2>
                                                                                    ...
                                                                                    <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                                        <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                            <tr>
                                                                                                <td height="100%" valign="top">
                                                                                                    <div class="box" style="text-align:center;border:1px solid #ccc;background:#fff;background-color:#fff;padding:15px;">
                                                                                                        <h2 style="padding:0;margin:0">{{ $total_ctr }}</h2>
                                                                                    ...
                                                                                    <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                                        <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                            <tr>
                                                                                                <td height="100%" valign="top">
                                                                                                    <div class="box" style="text-align:center;border:1px solid #ccc;background:#fff;background-color:#fff;padding:15px;">
                                                                                                        <h2 style="padding:0;margin:0">{{ $total_spend }}</h2>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td height="100%" valign="top">
                                                                                                    <table width="100%" border="1px" style="1px solid #cccccc" cellpadding="0" cellspacing="0">
                                                                                                        <tbody><tr><td width="100%" style="background-color:#ccc;padding:10px;" background-color="#ccc">Demographics</td></tr><tr><th style="background-color:#fff;padding:5px;">{!! $genders_graph_url == 'no_data' ? 'No data': '<img style="max-width: 100%" src="'.$genders_graph_url.'"/>' !!}</th></tr>
                                                                                                        </tbody></table>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                        ...
                                                                                        <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                            <tr>
                                                                                                <td height="100%" valign="top">
                                                                                                    <table width="100%" border="1px" style="1px solid #cccccc" cellpadding="0" cellspacing="0">
                                                                                                        <tbody>
                                                                                                        <tr><td width="100%" style="background-color:#ccc;padding:10px;" background-color="#ccc">Age</td></tr>
                                                                                                        <tr><th style="background-color:#fff;padding:5px;">{!! $ages_graph_url == 'no_data' ? 'No data': '<img style="max-width: 100%" src="'.$ages_graph_url.'"/>' !!}</th></tr>
                                                                                                        </tbody></table>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                ...
                                                                <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                    <tr>
                                                                        <td height="100%" valign="top">
                                                                            <h2 style="text-align:center;font-size:18px;margin:0 0 10px 0;padding:0 0 10px 0">Top 5 Ads by Performance</h2>
                                                                            ...
                                                                            <table width="100%" cellpadding="5" cellspacing="0" style="background:#fff">
                                                                                <tbody>
                                                                                    ...
                                                                                    @php($campaign_insight = (object) $campaign_insight)
