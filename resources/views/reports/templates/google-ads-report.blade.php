...
table th {font-family:Ubuntu, Helvetica, Arial, sans-serif;font-weight:normal}
    table,
    td {
...
<body style="background-color:#f2f2f2;">
  ...
  <span class="introtext">Hello! Here is your Google Ads Report.</span>
    ...
    <div style="Margin:0px auto;max-width:600px;">
                                ...
                                <tbody>
                                  <tr>
                                    <td style="width:200px;"> <img height="auto" src="https://s3-us-west-2.amazonaws.com/ninjareports/ninja+reports+logo+email.png"
                                        style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:175px" /> </td>
                                  </tr>
                                </tbody>
                              </table>
                            </td>
                                ...
                                <tr>
                                  <td align="center" bgcolor="transparent" role="presentation" style="border:1px solid transparent;border-radius:3px;cursor:auto;padding:10px 25px;" valign="middle">
                                    <p style="background:transparent;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;mso-line-height-rule:exactly;Margin:0;text-decoration:none;text-transform:none;"> 
                                      <span style="font-weight:bolder;display:inline-block;margin-bottom:3px;font-size:16px;text-align:right;">GOOGLE ADS REPORT</span> <br/>
                                      {{report_date}}
                                    </p>
                                  </td>
                                </tr>
      ...
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
        <tbody>
          <tr>
            <td style="direction:ltr;font-size:0px;padding:0px 0;padding-bottom:0;text-align:center;vertical-align:top;">
              <!--[if mso | IE]>
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <![endif]-->
              ...
              <!--        <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;mso-line-height-rule:exactly;text-align:;color:#ccc;"> {{report_date}} </div>-->
              <!--      </td>-->
              <!--    </tr>-->
              <!--  </table>-->
              <!--</div>-->
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10 0 10 0;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;table-layout:auto;width:100%;">
                        <tr>
                          <td><span style="width:90px;font-size:24px;display:inline-block;word-wrap:break-word;padding-left:15px;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:24px; color: #1180f3; line-height: 21px; text-decoration: none;">{{spend}}</span></td>
                          <td align="right" style="padding-right:5px"><img width="35" height="35" src="http://cdn.mcauto-images-production.sendgrid.net/a5b536ad3b0d9482/8405326e-8cbc-49b3-b351-ad22bcc7f4fe/35x35.png" /></td>
                        </tr>
                      </table>
                    </td>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:0;word-break:break-word;">
                      <table style="background-color:#fff;vertical-align:top;" cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;mso-line-height-rule:exactly;table-layout:auto;width:100%;">
                        <tr>
                          <td style="padding-left:15px;padding-bottom:10px;color:#ccc; font-size:14px;">SPEND($)</td>
                        </tr>
                      </table>
                    </td>
                    <td class="tdGridMarg">&nbsp;</td>
                    ...
                    <td align="left" style="font-size:0px;padding:10 0 10 0;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;table-layout:auto;width:100%;">
                        <tr style="background-color:#fff;">
                          <td><span style="width:90px;font-size:24px;display:inline-block;word-wrap:break-word;padding-left:15px;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:24px; color: #1180f3; line-height: 21px; text-decoration: none;">{{impressions}}</span></td>
                          <td align="right"><img width="35" height="35" src="http://cdn.mcauto-images-production.sendgrid.net/a5b536ad3b0d9482/9366d918-970f-464a-95f0-168cd917435f/35x35.png" /></td>
                        </tr>
                      </table>
                    </td>
                    <td class="tdGridMarg">&nbsp;</td>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:0;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;mso-line-height-rule:exactly;table-layout:auto;width:100%;">
                        <tr style="background-color:#fff;">
                          <td style="padding-left:15px;padding-bottom:10px;color:#ccc; font-size:14px;">IMPRESSIONS</td>
                        </tr>
                      </table>
                    </td>
                    <td class="tdGridMarg">&nbsp;</td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#fff;vertical-align:top;" width="100%">
                    ...
                    <td align="left" style="font-size:0px;padding:10 0 10 0;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;table-layout:auto;width:100%;">
                        <tr style="background-color:#fff;">
                          ...
                          <td><span style="width:90px;font-size:24px;display:inline-block;word-wrap:break-word;padding-left:15px;;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:24px; color: #1180f3; line-height: 21px; text-decoration: none;">{{ctr}}</span></td>
                          <td align="right"><img width="35" height="35" src="http://cdn.mcauto-images-production.sendgrid.net/a5b536ad3b0d9482/f6144e95-0eb6-4aff-aa0f-6d9e700d602b/35x35.png" /></td>
                        </tr>
                      </table>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" style="font-size:0px;padding:0;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;mso-line-height-rule:exactly;table-layout:auto;width:100%;">
                        <tr style="background-color:#fff;">
                          <td style="padding-left:15px;padding-bottom:10px;color:#ccc; font-size:14px;">CTR(%)</td>
                        </tr>
                      </table>
                    </td>
                  </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#fff;vertical-align:top;" width="100%">
                  <tr>
                    <td align="left" style="font-size:0px;padding:10 0 10 0;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;table-layout:auto;width:100%;">
                        <tr style="background-color:#fff;">
                          <td><span style="width:90px;font-size:24px;display:inline-block;word-wrap:break-word;padding-left:15px;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:24px; color: #1180f3; line-height: 21px; text-decoration: none;">{{clicks}}</span></td>
                          <td align="right"><img width="35" height="35" src="http://cdn.mcauto-images-production.sendgrid.net/a5b536ad3b0d9482/2f4d8311-a40d-4d9f-a56d-fea5676b7e41/35x35.png" /></td>
                        </tr>
                      </table>
                    </td>
                    <td class="tdGridMarg">&nbsp;</td>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:0;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;mso-line-height-rule:exactly;table-layout:auto;width:100%;">
                        <tr style="background-color:#fff;">
                          <td style="padding-left:15px;padding-bottom:10px;color:#ccc; font-size:14px;">CLICKS</td>
                        </tr>
                      </table>
                    </td>
                    <td class="tdGridMarg">&nbsp;</td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#fff;vertical-align:top;" width="100%">
                    ...
                    <td align="left" style="font-size:0px;padding:10 0 10 0;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;table-layout:auto;width:100%;">
                        <tr style="background-color:#fff;">
                          ...
                          <td><span style="width:90px;font-size:24px;display:inline-block;word-wrap:break-word;padding-left:15px;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:24px; color: #1180f3; line-height: 21px; text-decoration: none;;">{{avg_cpc}}</span></td>
                          <td align="right" style="padding-right:5px"><img width="35" height="35" src="http://cdn.mcauto-images-production.sendgrid.net/a5b536ad3b0d9482/9ca04d12-b7a5-4f9f-8544-711574c4b968/35x35.png" /></td>
                        </tr>
                      </table>
                    </td>
                    <td class="tdGridMarg">&nbsp;</td>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:0;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;mso-line-height-rule:exactly;table-layout:auto;width:100%;">
                        <tr style="background-color:#fff;">
                          <td style="padding-left:15px;padding-bottom:10px;color:#ccc; font-size:14px;">Avg CPC($)</td>
                        </tr>
                      </table>
                    </td>
                    <td class="tdGridMarg">&nbsp;</td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#fff;vertical-align:top;" width="100%">
                  <tr>
                    <td align="left" style="font-size:0px;padding:10 0 10 0;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;table-layout:auto;width:100%;">
                        <tr style="background-color:#fff;">
                          <td><span style="width:90px;font-size:24px;display:inline-block;word-wrap:break-word;padding-left:15px;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:24px; color: #1180f3; line-height: 21px; text-decoration: none;">{{conversions}}</span></td>
                          <td align="right"><img width="35" height="35"  src="http://cdn.mcauto-images-production.sendgrid.net/a5b536ad3b0d9482/0e13b500-6202-4ec5-b18e-ea88562367ad/35x35.png" /></td>
                        </tr>
                      </table>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" style="font-size:0px;padding:0;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;mso-line-height-rule:exactly;table-layout:auto;width:100%;">
                        <tr style="background-color:#fff;">
                          <td style="padding-left:15px;padding-bottom:10px;color:#ccc; font-size:14px;">CONVERSIONS</td>
                        </tr>
                      </table>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                        <tbody>
                          <tr>
                            <td style="width:100%;"> <img height="auto" src="{{spend_and_conversions_by_day_chart_url}}" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;"
                                width="550" /> </td>
                          </tr>
                        </tbody>
                      </table>
          ...
          <![endif]-->
              <div class="mj-column-per-50 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td align="left" style="font-size:0px;padding:0px 15px;word-break:break-word;">
                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"> <strong>MAP</strong> </div>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
