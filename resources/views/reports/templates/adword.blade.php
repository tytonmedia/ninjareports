      ...
      <tr>
        <td height="100%" valign="top" style="margin:15px 0;">
          <table width="100%" cellpadding="">
            <tr align="center" style="text-align:center;margin:10px 0"><td style="text-align:center;padding:10px 0"><h2 style="padding:5px 0;margin:0;text-align:center;">Your {{ ucfirst($report->frequency) }} Google Adwords Report</h2></td></tr>
...
<div style="padding:0;margin:0;display:block;font-size:30px;text-align:center">{{ $total_clicks }}</div>
<div style="padding:0;margin:0;display:block;text-align:center">Clicks</div>
      </td></tr>
         <tr role='module-content'>
        <td height="100%" valign="top" width="100%" style="width:100%;background:#ffffff;background-color:#ffffff;text-align:center;border:1px solid #cccccc">
<div style="padding:0;margin:0;display:block;font-size:30px;text-align:center">{{ $total_impressions }}</div>
<div style="padding:0;margin:0;text-align:center">Impressions</div>
       </td></tr>
        <tr role='module-content'>
        <td height="100%" valign="top" width="100%" style="width:100%;background:#ffffff;background-color:#ffffff;text-align:center;border:1px solid #cccccc">
...
<div style="padding:0;margin:0">Avg. CPC ($)</div>
  ...
  <tbody><tr><th style="background-color:#cccccc;padding:5px;">Demographics</th></tr><tr><td width="100%" style="background-color:#ffffff;padding:10px;" background-color="#ffffff">{!! $devices_graph_url == 'no_data' ? 'No data': '<img style="max-width: 100%" src="'.$devices_graph_url.'"/>' !!}</td></tr>
</tbody></table>


    <table border="1px" style="border:1px solid #cccccc;margin-bottom:1%" cellpadding="0" cellspacing="0" width="100%">
  <tbody><tr><th style="background-color:#cccccc;padding:5px;">Age</th></tr><tr><td width="100%" style="background-color:#ffffff;padding:10px;" background-color="#ffffff">{!! $locations_graph_url == 'no_data' ? 'No data': '<img style="max-width: 100%" src="'.$locations_graph_url.'"/>' !!}</td></tr>
</tbody></table>
  ...
  <table class="module" role="module" data-type="code" border="0" cellpadding="10" cellspacing="0" width="100%" style="table-layout: fixed;">
      <tr>
        <td height="100%" valign="top" style="text-align:center;padding:10px;margin:10px 0">
          <h2 style="text-align:center;font-size:18px;margin:10px0 0 10px 0;padding:10px 0 10px 0">Top 5 Campaigns by Clicks</h2>
