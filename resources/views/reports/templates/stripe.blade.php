                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                                    ...
                                                    <tr>
                                                        <td role="modules-container"
                                                            ...
                                                            bgcolor="#f2f2f2" width="100%" align="left">
                                                                ...
                                                                <tr>
                                                                    <td height="100%" valign="top">
                                                                        <table bgcolor="#3f3f3f"
                                                                               style="background:#3f3f3f;width:100%;max-height:75px;"
                                                                               height="75px;" width="100%"
                                                                               cellpadding="0" cellspacing="0">
                                                                            <tbody>
                                                                            <tr>
                                                                                <td style="width:200px;height:38px;padding:0 15px">
                                                                                    <a href="https://www.ninjareports.com/#utm_source=report&utm_medium=email&utm_campaign=logo_header&utm_term=facebook_ads"><img
                                                                                                class="max-width"
                                                                                                border="0"
                                                                                ...
                                                                                <td style="text-align:right;vertical-align:middle;padding:15px; ">
                                                                                    <a style="color:#fff;vertical-align:top;display:block;padding:5px;font-weight:bold;"
                                                                                       href="https://app.ninjareports.com/reports/create#utm_source=report&utm_medium=email&utm_campaign=create_report&utm_term=facebook_ads">CREATE
                                                                                        A REPORT</a></td>
                                                                            </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div style="text-align:center;margin:5px 0">
                                                                                        <h2 style="padding:5px 0;margin:0;color:#333">
                                                                                ...
                                                                                <td>
                                                                                    <div style="text-align:center;margin:5px 0">
                                                                                        <p style="color:#999;padding:5px 0;margin:0">
                                                                                            {{ date('m/d/Y', $report->next_send_time) }}</p>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                                    ...
                                                                                    <table class="module" role="module"
                                                                                        ...
                                                                                        <tr>
                                                                                            <td height="100%"
                                                                                                valign="top">
                                                                                                <div class="box"
                                                                                                     style="text-align:center;border:1px solid #ccc;background:#fff;background-color:#fff;padding:15px;">
                                                                                                    <h2 style="padding:0;margin:0;color:#1080F2;display:block;background:#fff">
                                                                                                        ${{ $total_balance }}</h2>
                                                                                                    <label style="padding:0;margin:0;display:block;background:#fff">Balance</label>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                    ...
                                                                                    <table class="module" role="module"
                                                                                        ...
                                                                                        <tr>
                                                                                            <td height="100%"
                                                                                                ...
                                                                                                <div class="box"
                                                                                                     style="text-align:center;border:1px solid #ccc;background:#fff;background-color:#fff;padding:15px;">
                                                                                                    <h2 style="padding:0;margin:0;color:#f00">
                                                                                                        ${{ calculateStripeAmount($total_refund_amount) }}</h2>
                                                                                                    <label style="padding:0;margin:0">Refunds</label>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                    ...
                                                                                    <table class="module" role="module"
                                                                                        ...
                                                                                        <tr>
                                                                                            <td height="100%"
                                                                                                ...
                                                                                                <div class="box"
                                                                                                     style="text-align:center;border:1px solid #ccc;background:#fff;background-color:#fff;padding:15px;">
                                                                                                    <h2 style="padding:0;margin:0;color:#1080F2">
                                                                                                        ${{ calculateStripeAmount($total_dispute_amount) }}</h2>
                                                                                                    <label style="padding:0;margin:0">Disputes</label>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td height="100%"
                                                                                                ...
                                                                                                <div class="box"
                                                                                                    ...
                                                                                                    <h2 style="padding:0;margin:0;color:#1080F2">
                                                                                                        {{ $total_customers }}</h2>
                                                                                                    <label style="padding:0;margin:0">Customers</label>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td height="100%"
                                                                                                ...
                                                                                                <div class="box"
                                                                                                     style="text-align:center;border:1px solid #ccc;background:#fff;background-color:#fff;padding:15px;">
                                                                                                    <h2 style="padding:0;margin:0;color:#1080F2">
                                                                                                        ${{ calculateStripeAmount($total_charge_amount) }}</h2>
                                                                                                    <label style="padding:0;margin:0">Charges</label>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td height="100%"
                                                                                                ...
                                                                                                <div class="box"
                                                                                                     style="text-align:center;border:1px solid #ccc;background:#fff;background-color:#fff;padding:15px;">
                                                                                                    <h2 style="padding:0;margin:0;color:#1080F2">
                                                                                                        ${{ calculateStripeAmount($total_payout_amount) }}</h2>
                                                                                                    <label style="padding:0;margin:0">Payouts</label>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                ...
                                                                <tr>
                                                                    <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                        ...
                                                                        <table class="wrapper" role="module"
                                                                               ...
                                                                               style="table-layout: fixed;">
                                                                            <tr>
                                                                                <td style="font-size:6px;line-height:10px;padding:15px 0px 15px 0px;"
                                                                                    valign="top" align="center">
                                                                                    <a href="https://www.ninjareports.com/#utm_source=report&utm_medium=email&utm_campaign=logo_footer&utm_term=facebook_ads"><img
                                                                                                class="max-width"
                                                                                                border="0"
                                                                                                style="display:block;color:#000000;text-decoration:none;font-family:Helvetica, arial, sans-serif;font-size:16px;"
                                                                                                src="https://marketing-image-production.s3.amazonaws.com/uploads/6a85ebdabdfb77a126cb7bf00bc4e6d57311fe1066183a13b069ef4c4d45787aeca594f03de289f41878cb97923a4cd1ef1d77b4d1409a7d10c00fb4b2cfab8b.png"
                                                                                                alt=""
                                                                                                data-proportionally-constrained="true"
                                                                                                width="150" height="28"></a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        <table width="350px" cellpadding="0"
                                                                            ...
                                                                            <tr>
                                                                                <td style="text-align:center;width:25%">
                                                                                    <a style="color:#ccc"
                                                                                       href="https://www.facebook.com/ninjareports/">Facebook</a>
                                                                                </td>
                                                                                <td style="text-align:center;width:25%">
                                                                                    <a style="color:#ccc"
                                                                                       href="https://twitter.com/ninja_reports">Twitter</a>
                                                                                </td>
                                                                                <td style="text-align:center;;width:25%">
                                                                                    <a style="color:#ccc"
                                                                                       href="https://www.youtube.com/channel/UCcjm2lXhxAYGoKS1nCe3vIQ">Youtube</a>
                                                                                </td>
                                                                                <td style="text-align:center;;width:25%">
                                                                                    <a style="color:#ccc"
                                                                                       href="https://www.linkedin.com/company/ninja-reports">LinkedIn</a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
