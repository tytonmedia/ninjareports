        ...
        <div class="col-md-12">
            @if($paused)
                <div class="alert alert-danger">
                    ...
                    You have reached the limit of your plan. <a href="{{ url('settings#/subscription') }}">Upgrade your
                        plan</a> to resume your reports.
                </div>
            @endif
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6 text-right greeting-button">
                            <a href="{{ route('reports.index') }}" class="btn btn-black"><i class="fa fa-angle-left"
                                                                                            aria-hidden="true"></i>&nbsp;
                                Reports</a>
                        </div>
                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <select class="form-control frequency" name="frequency">
                                            ...
                                            @endif
                                            <option value="weekly" {{ $report->frequency == 'weekly' ? 'selected':'' }} >
                                                Weekly
                                            </option>
                                            <option value="monthly" {{ $report->frequency == 'monthly' ? 'selected':'' }} >
                                                Monthly
                                            </option>
                                            <option value="yearly" {{ $report->frequency == 'yearly' ? 'selected':'' }} >
                                                Yearly
                                            </option>
                                        </select>
                                        <div class="error">
                                    ...
                                    <div class="ends_at_section">
                                        @if($report->frequency == 'daily')
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="ends_at" value="{{ $report->ends_at }}"
                                                       readonly class="custom-readonly form-control timepicker"/>
                                            </div>
                                        @endif
                                        @if($report->frequency == 'weekly')
                                            ...
                                            <div class="col-md-5">
                                                <select name="ends_at" class="form-control">
                                                    <option value="Mon" {{ $report->ends_at == 'Mon' ? 'selected':'' }} >
                                                        Mon
                                                    </option>
                                                    <option value="Tue" {{ $report->ends_at == 'Tue' ? 'selected':'' }} >
                                                        Tue
                                                    </option>
                                                    <option value="Wed" {{ $report->ends_at == 'Wed' ? 'selected':'' }} >
                                                        Wed
                                                    </option>
                                                    <option value="Thu" {{ $report->ends_at == 'Thu' ? 'selected':'' }} >
                                                        Thu
                                                    </option>
                                                    <option value="Fri" {{ $report->ends_at == 'Fri' ? 'selected':'' }} >
                                                        Fri
                                                    </option>
                                                    <option value="Sat" {{ $report->ends_at == 'Sat' ? 'selected':'' }} >
                                                        Sat
                                                    </option>
                                                    <option value="Sun" {{ $report->ends_at == 'Sun' ? 'selected':'' }} >
                                                        Sun
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        @if($report->frequency == 'yearly')
                                            ...
                                            <div class="col-md-3">
                                                <select name="ends_at_month" class="form-control">
                                                    <option value="1" {{ $y_date[0] == 1 ? 'selected':'' }} >Jan
                                                    </option>
                                                    <option value="2" {{ $y_date[0] == 2 ? 'selected':'' }} >Feb
                                                    </option>
                                                    <option value="3" {{ $y_date[0] == 3 ? 'selected':'' }} >Mar
                                                    </option>
                                                    <option value="4" {{ $y_date[0] == 4 ? 'selected':'' }} >Apr
                                                    </option>
                                                    <option value="5" {{ $y_date[0] == 5 ? 'selected':'' }} >May
                                                    </option>
                                                    <option value="6" {{ $y_date[0] == 6 ? 'selected':'' }} >Jun
                                                    </option>
                                                    <option value="7" {{ $y_date[0] == 7 ? 'selected':'' }} >Jul
                                                    </option>
                                                    <option value="8" {{ $y_date[0] == 8 ? 'selected':'' }} >Aug
                                                    </option>
                                                    <option value="9" {{ $y_date[0] == 9 ? 'selected':'' }} >Sep
                                                    </option>
                                                    <option value="10" {{ $y_date[0] == 10 ? 'selected':'' }} >Oct
                                                    </option>
                                                    <option value="11" {{ $y_date[0] == 11 ? 'selected':'' }} >Nov
                                                    </option>
                                                    <option value="12" {{ $y_date[0] == 12 ? 'selected':'' }} >Dec
                                                    </option>
                                                </select>
                                            </div>
                                        @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" name="email_subject"
                                               value="{{ old('email_subject') ? old('email_subject') : $report->email_subject }}"/>
                                        <div class="error">
...
@if(isset($templates))
   ...
   selected_template_id = {{$report->template_id}};
