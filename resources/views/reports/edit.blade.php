								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<div id="tab" class="btn-group btn-group-justified attachment" data-toggle="buttons">
											...
											<a href="#scv" class="hidden btn btn-default{{ old('attachment_type') == 'csv' ? ' active':($report->attachment_type == 'csv' ? ' active': '') }}" data-toggle="tab">
...
@if(isset($templates))
   ...
   var selected_id= {{$report->template_id}};
   ...
   function setTemplateOption(){
	   ...
	   for(var i=0;i<templates.length;i++){
		  ...
		  if(account_type == templates[i]['account_type']){
			if(templates[i]['id'] == selected_id){ selected = "selected=selected"; }
